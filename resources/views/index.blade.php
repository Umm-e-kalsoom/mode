...
<html lang="en"
	...
	<head>
	    ...
	    <link href="https://cabme-landing.siswebapp.com/css/bootstrap.min.css" rel="stylesheet">
	    <link href="https://cabme-landing.siswebapp.com/css/style.css" rel="stylesheet">
	    <script type="490cf4da05ddb33bf38d2254-text/javascript" src="https://cabme-landing.siswebapp.com/js/bootstrap.bundle.min.js"></script>
	...
	<div class="container">
		<div class="row">
			<div class="main-logo col-md-6">
				<div class="site-logo">
					<a href="https://cabme-landing.siswebapp.com"> <img class="img-fluid" src="{{ asset('images/hail.png ') }}" alt="logo" style="height:150px !important;"> </a>
				</div>
			</div>
	...
	<div class="container">
		...
		<section class="footer-copyright border-top py-3">
			<div class="container text-center">
				<p class="mb-0">
					© Copyright 2022-2023 Hail A Taxi. All rights reserved.
				</p>
				<p class="mb-0"></p>
			</div>
		</section>
